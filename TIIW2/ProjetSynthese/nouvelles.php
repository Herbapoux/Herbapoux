...
<section id="nouvelles" class="container-fluid h-50 p-0">
            ...
            <div class="col-12 d-flex flex-wrap align-items-center">
                <div class="container pt-5 pb-5">
                    ...
                    <div class="offset-sm-1 col-sm-10 offset-md-2 col-md-8">
                        <img class="img-fluid imageMaxime d-none d-sm-block" src="img/JeuneGarconContent.jpeg" alt="Garçon piscine" title="Maxime Leroux"/>
    ...
    <div class="container">
        ...
        <div class="row align-items-center pt-4 pb-4">
            ...
            <div class="col-6 d-none d-md-block">
                <img class="img-fluid" src="img/JeuneGarconContent.jpeg" alt="Image de garçon" title="Maxime">
            </div>
        </div>
    </div>
